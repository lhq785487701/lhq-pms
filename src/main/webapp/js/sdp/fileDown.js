...
$(function() {
	var down = {
		createDownIframe : function(id, uri) {
			// create frame
			var frameId = 'jDownFrame' + id;
		...
		createDownForm : function(id, data) {
			// create form
			var formId = 'jDownForm' + id;
		...
		download : function(s) {
			...
			var form = jQuery.createDownForm(id,
					(typeof (s.data) == 'undefined' ? false : s.data));
			var io = jQuery.createDownIframe(id, s.secureuri);
			var frameId = 'jDownFrame' + id;
			var formId = 'jDownForm' + id;
			...
			var uploadCallback = function(isTimeout) {
				...
				if (xml || isTimeout == "timeout") {
					requestDone = true;
					var status;
					var tmp=xml.responseText!=null?xml.responseText:xml.responseXML;
					try {
						...
						if (status != "error") {
							...
							var data = jQuery.downHttpData(xml, s.dataType);
