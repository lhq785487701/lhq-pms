...
$(function() {
	...
	prjChange.statement = "SDP-RYCHANGE-001";
	prjChange.$update = 'SDP-RYCHANGE-003';
	prjChange.$delete = 'SDP-RYCHANGE-004';
	...
	var rules = {
		...
		/*
		 * prj_year : [ { required : true, trigger : 'blur', message : '请选择立项年份' } ],
		 */
		...
		/*
		 * prj_start_time : [{ required : true, trigger : 'blur', message :
		 * '请选择项目开始时间' }], prj_end_time : [{ required : true, trigger : 'blur',
		 * message : '请选择项目结束时间' }],
		 */
		prj_desc : [ {
			required : true,
